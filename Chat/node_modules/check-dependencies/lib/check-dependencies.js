...
>
    installOrPrune('install');
    const pruneExcessive = () =
>
    installOrPrune('prune');
...
module.exports = (cfg, cb) =
>
checkDependenciesHelper('async', cfg, cb);
module.exports.sync = (cfg, cb) =
>
checkDependenciesHelper('sync', cfg, cb);
