            ...
            <div id="newProcess" class="half-screen">
                ...
                <br>
                    <div class="center entire-screen" style="border: solid">
                        ...
                        <br>
                        <small @if($process->active==1)style="color: green" @else style="color: indianred"@endif >@if($process->active==1)Active @else Inactive @endif</small>
                        <br>
...
<!-- EDIT DESTINATION -->
                @if($user->role == 'student')
                    <div class="entire-screen">
                        <button id="editDestinationButton"><h5>Edit Destination</h5></button><br><br>
                        ...
                        <button id="uploadButton"><h5>Upload Files</h5></button><br><br>
                            <div class="entire-screen" id="uploadOptions" class="half-screen" hidden>
                                ...
                                @if($user->role == 'student'/*If role is student, then can upload anything.*/)
                                        ...
                                        <input type="file" name="file3" id="uploadOption3" class="fileEvent" style="color: dimgrey;">  <strong>|-> Upload English Certificate</strong></input><br><br>
                                        <input type="file" name="file4" id="uploadOption4" class="fileEvent" style="color: dimgrey;">  <strong>|-> Upload Profile Photo</strong></input><br><br>
                                        <input type="file" name="file5" id="uploadOption5" class="fileEvent" style="color: dimgrey;">  <strong>|-> Upload ID Card</strong></input><br><br>
                                        <input type="file" name="file6" id="uploadOption6" class="fileEvent" style="color: dimgrey;">  <strong>|-> Upload NIB declaration</strong></input><br><br>
                                    @endif()
