...
<div class="entire-screen center"
     style="height: 80vh;background-image: url(/img/backgroundLogin.jpg);background-repeat: no-repeat;background-size:cover;margin-top: 103px;padding-right: 0px !important;padding-bottom: 0px !important;">
    ...
    <div class="seventy-screen"
        ...
        <div class="entire-screen" style="margin: 50px 0px;padding: 0px 0px !important;">
            ...
            <div class="entire-screen"
                 style="margin-top: 83px;padding-right: 0px !important;padding-bottom: 0px !important;">
                <div class="entire-screen center">
                    <br>
